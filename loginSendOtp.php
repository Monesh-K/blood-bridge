				...
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
						...
						<div class="login-wrap p-4 p-md-5">
							...
							<form class="signin-form" method="POST" action="logincheck.php">
								...
								<!-- <div class="form-group d-md-flex">
									...
									<div class="w-50 text-md-right">
										<button action="sendotp.php">Send OTP</button>
									</div>
								</div> -->
							</form>
							<p class="text-center">
   ...
   $('#mobile').blur(function(){
     ...
     $.ajax({
      ...
      success:function(data)
      {
       ...
       {$('#availability').html('<span class="text-danger text-sm">Account does not exist. Signup to continue.</span>');
