...
$to_id = mysqli_real_escape_string($con, $row['id']);
$my_req = "SELECT * FROM requests WHERE to_id='$to_id'";
...
<body>
  ...
  <div class="container mt-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center">
                <a href="accept.php?from_id=<?php echo $row3['from_id']; ?>&to_id=<?php echo $row3['to_id']; ?>" class="btn btn-success mx-2">Accept</a>
                <a href="decline1.php?from_id=<?php echo $row3['from_id']; ?>&to_id=<?php echo $row3['to_id']; ?>" class="btn btn-danger mx-2">Decline</a>
    ...
    <?php
      ...
      echo '<div class="card card-body text-center mx-auto" style="width: fit-content;">You have not received any request.</div>';
    }
    ?>
  </div>
</body>
