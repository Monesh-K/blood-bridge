  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #f2ebe4; padding:8px 0px;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active card" href="signupSendOtp.php">Sign&nbsp;up</a>
        </li>
      </ul>
    </div>
  </nav>
      ...
      <div class="col-md-7 col-lg-5">
        <div class="wrap">
          ...
          <div class="login-wrap p-4 p-md-5">
            ...
            <form action="signupcheck.php" method="POST" class="signin-form">
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="name" id='name' required />
                <label class="form-control-placeholder" for="username">Name</label>
              </div>
              <!-- <div class="form-group mt-3">
									<input type="text" class="form-control" name="aadhar" id="aadhar" maxlength="12"required/>
									<label class="form-control-placeholder" for="username">Aadhar Number</label>
								</div> -->
              <span id="availability"></span>

              <div class="form-group mt-3">
                <input type="text" class="form-control" maxlength="10" name="mobile" id="mobile" required />
                <label class="form-control-placeholder" for="username">Mobile</label>
              </div>


              <div class="form-group">
                <button type="submit" name="sendotp" id="sendotp" class="form-control btn btn-primary rounded submit px-3">
                  Send OTP
                </button>
              </div>
            </form>
            <p class="text-center">
              Already have an Account? <a href="loginSendOtp.php">Login</a>
            </p>
          </div>
        </div>
      </div>
    ...
    $('#name').blur(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data != '0') {
            $('#availability').html('<span class="text-danger text-sm">Username must be Unique.</span>');
