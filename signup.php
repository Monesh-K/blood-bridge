        ...
        <div class="wrap">
          ...
          <div class="login-wrap p-4 p-md-5">
            ...
            <form action="signupcheck.php" method="POST" class="signin-form">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" maxlength="10" value="<?php echo $_SESSION['mobile']; ?>" />
                <label class="form-control-placeholder" for="username">Mobile</label>
              </div>
              <!-- <div class="form-group mt-3">
									<input type="text" class="form-control" value="<?php echo $_SESSION['aadhar']; ?>" />
									<label class="form-control-placeholder" for="username">Aadhar Number</label>
								</div> -->
              <div class="form-group">
                <input id="password-field" type="text" class="form-control" name="enteredOtp" required autofocus />
                <label class="form-control-placeholder">OTP</label>
                <!-- <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span> -->
              </div>
              <div class="form-group">
                <button type="submit" name="signup" class="form-control btn btn-primary rounded submit px-3">
                  Sign Up
                </button>
              </div>
            </form>
